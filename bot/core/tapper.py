...
class Tapper:
    ...
    async def get_profile_data(self, http_client: aiohttp.ClientSession):
        try:
            response = await http_client.get(url='https://api-backend.yescoin.fun/account/getAccountInfo')
            response.raise_for_status()
    ...
    async def get_game_data(self, http_client: aiohttp.ClientSession):
        try:
            response = await http_client.get(url='https://api-backend.yescoin.fun/game/getGameInfo')
            response.raise_for_status()
    ...
    async def get_boosts_info(self, http_client: aiohttp.ClientSession):
        try:
            response = await http_client.get(url='https://api-backend.yescoin.fun/build/getAccountBuildInfo')
            response.raise_for_status()
    ...
    async def get_special_box_info(self, http_client: aiohttp.ClientSession):
        try:
            response = await http_client.get(url='https://api-backend.yescoin.fun/game/getSpecialBoxInfo')
            response.raise_for_status()
    ...
    async def apply_turbo_boost(self, http_client: aiohttp.ClientSession):
        try:
            response = await http_client.post(url='https://api-backend.yescoin.fun/game/recoverSpecialBox')
            response.raise_for_status()
    ...
    async def apply_energy_boost(self, http_client: aiohttp.ClientSession):
        try:
            response = await http_client.post(url='https://api-backend.yescoin.fun/game/recoverCoinPool')
            response.raise_for_status()
    ...
    async def send_taps(self, http_client: aiohttp.ClientSession, taps: int) -> bool:
        try:
            response = await http_client.post(url='https://api-backend.yescoin.fun/game/collectCoin', json=taps)
            response.raise_for_status()
    ...
    async def send_taps_with_turbo(self, http_client: aiohttp.ClientSession) -> bool:
        try:
            ...
            response = await http_client.post(url='https://api-backend.yescoin.fun/game/collectSpecialBoxCoin',
